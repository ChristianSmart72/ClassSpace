    ...
    <div className="min-h-dvh flex flex-col bg-app-bg px-6 py-12">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-jakarta font-bold text-app-text mb-1">Welcome back</h1>
          <p className="text-app-text-dim text-sm font-inter">Sign in to your ClassSpace</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-app-accent text-app-bg font-jakarta font-bold text-sm rounded-xl py-3.5 mt-1 active:scale-[0.98] transition-all duration-200 disabled:opacity-50"
          >
            {loading ? 'Signing in…' : 'Sign In'}
          </button>
        </form>

        <p className="text-app-text-dim text-sm font-inter text-center mt-5">
          No account?{' '}
