  ...
  return (
    <div className="min-h-dvh flex flex-col px-6 py-12">
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        ...
        <p className="text-app-text-dim text-sm font-dm mb-8">Sign in to your ClassSpace</p>
        ...
        <div className="mt-6 p-4 bg-app-surface rounded-2xl border border-app-border">
          <p className="text-app-text-dim text-xs font-dm mb-2">Demo account:</p>
          <p className="text-app-text text-xs font-dm">christian@classspace.app / demo1234</p>
        </div>
      </div>
    </div>
  );
